...
class srcDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array())
    {
        ...
        $this->fileMap = array(
            'App\\Controller\\AbonnementCtrl' => __DIR__.'/getAbonnementCtrlService.php',
            'App\\Controller\\DefaultController' => __DIR__.'/getDefaultControllerService.php',
            'App\\Controller\\PaiementCtrl' => __DIR__.'/getPaiementCtrlService.php',
            'App\\Controller\\UserCtrl' => __DIR__.'/getUserCtrlService.php',
            'App\\Controller\\VideoCtrl' => __DIR__.'/getVideoCtrlService.php',
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('hTUmwbhiSH', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['logger'] ?? $this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()));
    }
